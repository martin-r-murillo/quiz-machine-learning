...
# -----------------------------------------------------------------------------
# PEGA ESTO JUSTO DESPUÉS DE CERRAR LA LISTA "FULL_DATA = [...]" EN APP.PY
# (Asegúrate de tener "import random" al inicio del archivo junto a streamlit)
# -----------------------------------------------------------------------------

import random # <--- ¡IMPORTANTE! Asegúrate de añadir esto arriba del todo

# --- 2. CONFIGURACIÓN Y ESTILOS ---
# (Mantenemos la configuración que ya funciona bien)
